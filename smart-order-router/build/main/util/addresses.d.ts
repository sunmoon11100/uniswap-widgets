...
export declare const WETH9: {
    [chainId in Exclude<ChainId, ChainId.POLYGON | ChainId.POLYGON_MUMBAI | ChainId.CELO | ChainId.CELO_ALFAJORES | ChainId.GNOSIS | ChainId.MOONBEAM | ChainId.BNB | ChainId.AVALANCHE | ChainId.OPTIMISM_SEPOLIA | ChainId.ARBITRUM_SEPOLIA | ChainId.ZORA | ChainId.ZORA_SEPOLIA | ChainId.ROOTSTOCK | ChainId.BLAST | ChainId.COSTON2>]: Token;
};
