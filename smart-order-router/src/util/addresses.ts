...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = UNISWAP_V3_CORE_FACTORY_ADDRESSES

export const QUOTER_V2_ADDRESSES: AddressMap = QUOTER_ADDRESSES
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = MULTICALL_ADDRESSES
