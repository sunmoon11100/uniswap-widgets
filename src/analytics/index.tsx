import { TraceEvent as AnalyticsEvent, sendAnalyticsEvent as sendAnalyticsTraceEvent } from '@uniswap/analytics'
...
export const TraceEvent = memo(function (props: React.ComponentProps<typeof AnalyticsEvent>) {
  const allowAnalytics = useAtomValue(allowAnalyticsAtom)
  const shouldLogImpression = allowAnalytics ? props.shouldLogImpression : false
