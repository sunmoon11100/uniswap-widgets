...
const InputTitle = styled(ThemedText.Body2)`
  color: ${({ theme }) => theme.primary};
  font-size: 12px;
  font-weight: 535;
`

const ButtonLabel = styled(ThemedText.Body1)<{ disabled: boolean }>`
  color: ${({ theme, disabled }) => (disabled ? theme.activeSoft : theme.accent)} !important;
  display: flex;
`
